...
import UpdateTokenDTO, { ChangePinDTO, ChangePinWithCodeDTO, UpdatePinDTO } from './dto/newToken.dto';
...
export class UsersController {
  ...
  @ApiOperation({
    description:
      'Updates the token for a logged in user.',
  })
  async updateToken(
  ...
  @ApiOperation({
    description:
      'Creates purchase pin for merchant.',
  })
  async updatePin(
    @Param() { id }: FindOneParams,
    @Body() data: UpdatePinDTO,
  ) {
    return await this.usersService.updatePin(
      id,
      data.pin,
    );
  }
  @Put('/:id/change-purchase-pin')
  @UseGuards(RoleAndJWTAuthenticationGuard(BoostaRoles.Merchant))
  @ApiBearerAuth()
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    description:
      'changes purchase pin for merchant.',
  })
  async changePin(
    @Param() { id }: FindOneParams,
    @Body() data: ChangePinDTO,
  ) {
    return await this.usersService.changePin(
      id,
      data.oldPin,
      data.newPin
    );
  ...
  async updatePurchasePinWithCode(
    @Param() { id }: FindOneParams,
    @Body() data: ChangePinWithCodeDTO,
  ) {
    return await this.usersService.updatePurchasePinWithCode(
      id,
      data.code,
      data.pin,
      data.pinConfirmation
    );
  }
